...
def transcode_video(input_path, output_dir, video_id):
    ...
    # 1. 720p: ffmpeg -i input.mp4 -vf scale=-2:720 -c:v libx264
    #          -crf 23 -preset fast output_720p.mp4
    # 2. 480p: ffmpeg -i input.mp4 -vf scale=-2:480 -c:v libx264
    #          -crf 23 -preset fast output_480p.mp4
